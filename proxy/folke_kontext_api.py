...
def folke_kontext_api(request):
    ...
    try:
        ...
        if mime_type == 'text/html':
            ...
            css_file_path = os.path.join(settings.BASE_DIR, "proxy", "folke_kontext_api_files", "custom_styles.css")
        ...
        # Handle CSS content
            ...
            # Ersätt font-display:swap med font-display:block
            modified_css = modified_css.replace('font-display:swap', 'font-display:block')
